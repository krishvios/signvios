...
#define RTUSB_URB_ALLOC_BUFFER(pUsb_Dev, BufSize, pDma_addr)			usb_buffer_alloc(pUsb_Dev, BufSize, GFP_KERNEL, pDma_addr)
...
USBHST_STATUS RTUSBBulkOutDataPacketComplete(purbb_t pUrb, struct pt_regs *pt_regs);
USBHST_STATUS RTUSBBulkOutMLMEPacketComplete(purbb_t pUrb, struct pt_regs *pt_regs);
USBHST_STATUS RTUSBBulkOutNullFrameComplete(purbb_t pUrb, struct pt_regs *pt_regs);
USBHST_STATUS RTUSBBulkOutRTSFrameComplete(purbb_t pUrb, struct pt_regs *pt_regs);
USBHST_STATUS RTUSBBulkOutPsPollComplete(purbb_t pUrb, struct pt_regs *pt_regs);
USBHST_STATUS RTUSBBulkRxComplete(purbb_t pUrb, struct pt_regs *pt_regs);
