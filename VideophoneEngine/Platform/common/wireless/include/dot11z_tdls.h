...
typedef struct PACKED _TDLS_LINK_IDENTIFIER_IE
{
...
typedef struct PACKED _TDLS_WAKEUP_SCHEDULE_IE
{
	UINT32	Interval;
...
typedef struct PACKED _TDLS_AP_PHY_DATA_RATE_IE
{
	UINT32	AP_PHY_Data_Rate;
} TDLS_AP_PHY_DATA_RATE_IE, *PTDLS_AP_PHY_DATA_RATE_IE;

typedef struct PACKED _TDLS_CHANNEL_SWITCH_TIMING_IE
{
	UINT16	SwitchTime;
