...
{
	m_ledMap = {{estiLED_MISSED_CALL, CLed (static_cast<int>(STATUS_LED_TYPE::MISSED_CALL))},
				{estiLED_SIGNMAIL, CLed (static_cast<int>(STATUS_LED_TYPE::SIGNMAIL))}};
}
...
{ 
	...
	statusLedSet (static_cast<STATUS_LED_TYPE>(led->IdGet ()), r, g, b);
