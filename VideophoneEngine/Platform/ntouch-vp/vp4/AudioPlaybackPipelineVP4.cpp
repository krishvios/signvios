...
#define AEC_CARD "zl380xxtw"


AudioPlaybackPipelineVP4::AudioPlaybackPipelineVP4 ()
{
	aecOutputDeviceSet (
		APUtility::hardwareIdGet (APUtility::Direction::Play, AEC_CARD));
}

GStreamerBin AudioPlaybackPipelineVP4::aecBinGet ()
{
	...
	stiTESTCONDMSG (bLinked, stiRESULT_ERROR, "AudioPlaybackPipelineVP4::aecBinGet: Failed to link queue2 through aecsink\n");
