...
BOOST_SRC_DIR=./../boost_source/boost
...
GOOGLE_DIR=/Users/cdadgari/dev/android-ndk-r12
...
#./build_tools/build-boost.sh --version=1.65.1 --stdlibs="gnu-4.9, llvm-3.5" --abis="armeabi-v7a"  --ndk-dir=$ANDROID_NDK_ROOT --linkage="shared,static" --verbose $BOOST_SRC_DIR  2>&1 | tee -a $logFile 
...
./build_tools/build-boost.sh --version=1.65.1 --stdlibs="gnu-4.9" --abis="armeabi-v7a"  --ndk-dir=$ANDROID_NDK_ROOT --linkage="shared,static" --verbose $BOOST_SRC_DIR  2>&1 | tee -a $logFile 
