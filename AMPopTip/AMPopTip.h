...
/** Configures gradient
 *
 * Sets colors used by DrawRect to add gradient to path
 */
...
/** Gradient
 *
 * Tells DrawRect to draw a gradient.  Defaults will be used unless provided, use -setGradientTopColor:BottomColor
 */
