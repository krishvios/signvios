...
- (void)commonInit {
	...
	_useGradient = NO;
	_gradientColorTop = kDefaultGradientTopColor;
	_gradientColorBottom = kDefaultGradientBottomColor;
}
...
- (void)drawRect:(CGRect)rect {
	...
	if (self.useGradient)
	{
		...
		NSArray *gradientColors = @[ (id) self.gradientColorTop.CGColor, (id) self.gradientColorBottom.CGColor];
...
- (void)setGradientTopColor:(UIColor *)topColor bottomColor:(UIColor *)bottomColor {
	self.gradientColorTop = topColor;
	self.gradientColorBottom = bottomColor;
}
